        ...
        <div class="row">
                <div class="card card-info ">
                   ...
                   <div style="float: right;">
                      <a onclick='javascript: confirmBeforeAccept(event); return false;' href="accept.php?parcel_d=<?php echo $id; ?>" class="btn btn-primary me-3">Accept</a>
                      <a onclick='javascript: confirmBeforeDecline(event); return false;' href="decline.php?parcel_d=<?php echo $id; ?>" class="btn btn-danger me-3">Declined</a>
                      ...
                      <a href="new_messages.php" class="btn btn-dark">Back</a>
