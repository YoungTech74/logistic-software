...
// session_start();
    ...
    if(isset($_SESSION['admin_user'])){
        $admin_login = $_SESSION['admin_user'];

        $fetchUser = mysqli_query($conn, "SELECT * FROM users WHERE username = '$admin_login'") or die(mysqli_error($conn));
        ...
        // $hash_confirm_password = password_hash($confirm_password, PASSWORD_DEFAULT);
    ...
    if(isset($_POST['updateBtn'])){
        ...
        if(empty($fullname)){
            ...
            $updateRecord = mysqli_query($conn, "UPDATE users SET full_name ='$fullname', username ='$username', email ='$email', phone_number ='$phone',
                            password = '$hashPassword', image = '$file_name' WHERE username = '$admin_login' && user_type = 1") or die(mysqli_error($conn));
    ...
    <h2 class="text-center">You have to login first!</h2>
  <?php
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="" method="POST" id="formId"  enctype="multipart/form-data">
        ...
        <div class="input-group mt-3">
          <input type="password" class="form-control" name="confirm_password" placeholder="Retype password" value="<?php echo $password; ?>">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
