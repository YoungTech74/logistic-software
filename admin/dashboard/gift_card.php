...
if(isset($_POST['gift_card_btn'])){

    $message = trim(mysqli_real_escape_string($conn, $_POST['message']));


    $query = mysqli_query($conn, "UPDATE users SET gift_card = '$message', seen = 0 WHERE user_type = 0");
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 form-group ">
                  ...
                  <textarea name="message" id="" cols="30" rows="2" class="form-control" required></textarea>
                </div>

                <div class="card-footer border-top border-info">
                <div class="d-flex w-100 justify-content-center align-items-center">
                    <button class="btn btn-flat  bg-gradient-primary mx-2" name="gift_card_btn">Send</button>
