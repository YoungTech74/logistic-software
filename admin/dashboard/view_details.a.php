        ...
        <div class="row">
                <div class="card card-info ">
                   ...
                   <div style="float: right;">
                      <a href="parcel_delivered.php" class="btn btn-dark">Delivered</a>
                      <a href="parcel_in_process.php" class="btn btn-dark">IN Process</a>
                      <a href="parcel_accepted.php" class="btn btn-dark">Back</a>
