...
if(isset($_SESSION['userid'])){
	...
	$package = "SELECT * FROM packages WHERE accept = 0 AND seen = 1 ORDER BY package_id DESC"or die(mysqli_error($conn));
					...
					<?php
					 ...
					 while($row = mysqli_fetch_assoc($sql)){?>
									...
									<li class="nav-item">
											<div class="btn-group nav-link me-3">
												...
												<div class="dropdown-menu me-4" role="menu" style="width: 30px;">
													...
													<a onclick='javacript: declinedPackage(event); return false;' class="dropdown-item ms-" href="delete_declined_parcel.php?delete_id=<?php echo $row['package_id'] ?>">Delete &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fas fa-trash text-danger"></span></a>
												</div>
						...
						echo "</table>";
							...
							$sql = mysqli_query($conn, "SELECT * FROM `packages` WHERE accept = 0 AND seen = 1 ORDER BY packages.package_id ASC;");
							?>
...
<!------------------------------- function to confirm before deleting package by id  ------------------->
<script>
	function declinedPackage(e){
