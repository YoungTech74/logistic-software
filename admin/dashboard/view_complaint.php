...
<h2 style="padding: 10px;" class="text-center">All Clients Complaints</h2>
	...
	<div class="card card-outline card-primary">
		...
		//----------------------------search query-------------------------
			if(isset($_POST['searchBtn'])){
				$sql = mysqli_query($conn, "SELECT * FROM `complaints` WHERE username like '%$_POST[search]%' ORDER BY complaints.id DESC");
							...
							<li class="nav-item">
									<div class="btn-group nav-link me-3">
										...
										<div class="dropdown-menu me-4" role="menu" style="width: 30px;">
											<a class="dropdown-item" href="reply.php?msg_id=<?php echo $row['id'] ?>">Reply &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-user" style=""></span></a>
											<div class="dropdown-divider"></div>
											<a onclick='return confirm("Are you sure you want to delete this message?")' class="dropdown-item ms-" href="delete_complaint.php?delete_id=<?php echo $row['id'] ?>">Delete &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fas fa-trash text-danger"></span></a>
										</div>
...
<!------------------ function to confirm before deleting item  ----------------------->
<script>
    function deleteComplaint(e){
        var confirmBeforeDelete = confirm("Are you sure you want to delete this item?");
        if(confirmBeforeDelete){
            windown.location = e.attr("href");
        }
    }
</script>
