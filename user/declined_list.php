    ...
    <div class="row container m-auto">
        <div class="row">
                <div class="card card-info ">
                    ...
                    <h3 class="card-title">Package Details: <span style="color: white; background: red; padding: 5px 10px;"> Declined </span></h3> 
                   <div style="float: right;">
                      <a href="declined_package.php" class="btn btn-dark">Back</a>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="card-body col-sm-3">
                                <p  class="text-cente"><img style="width: 230px; height: 150px; margin-right: -14px;" src="../images/<?= $image; ?>"></p>
                            </div>
