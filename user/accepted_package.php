...
if(isset($_SESSION['fullname'])){
	...
	$package = "SELECT * FROM packages WHERE accept = 1 && seen = 1 && sender_name = '$user' ORDER BY package_id DESC"or die(mysqli_error($conn));
...
<div class="col-lg-12">
	...
	if(isset($_POST['searchBtn'])){
		$sql = mysqli_query($conn, "SELECT * FROM `packages` WHERE company_name like '%$_POST[search]%' && accept = 1 && sender_name = '$user' ORDER BY packages.package_id ASC");
			...
			<li class="nav-item">
					<div class="btn-group nav-link me-3">
						...
						<div class="dropdown-menu me-4" role="menu" style="width: 30px;">
							...
							<a onclick='javacript: confirmDeletion(event); return false;' class="dropdown-item ms-" href="delete_parcel.a.php?delete_id=<?php echo $row['package_id'] ?>">Delete &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fas fa-trash text-danger"></span></a>
						</div>
  ...
  <?php include_once './footer.php'; ?>
	...
	<script>
		function confirmDeletion(e){
			var confirmDelete = confirm("Are you sure you want to accept this package?");
			if(confirmDelete){
