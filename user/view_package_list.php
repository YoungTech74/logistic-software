...
<h2 style="padding: 10px;" class="text-center">All Sent Packages</h2>
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		//----------------------------search query-------------------------
			if(isset($_POST['searchBtn'])){
				...
				$sql = mysqli_query($conn, "SELECT * FROM `packages` WHERE company_name like '%$_POST[search]%' && sender_name = '$_SESSION[fullname]' ORDER BY packages.package_id DESC");
				...
				<?php
					 ...
					 while($row = mysqli_fetch_assoc($sql)){?>
							...
							<li class="nav-item">
									<div class="btn-group nav-link me-3">
										...
										<div class="dropdown-menu me-4" role="menu" style="width: 30px;">
											...
											<a onclick='javascript:confirmDeletion($(this)); return false;' class="dropdown-item" href="delete_parcel.php?delete_id=<?php echo $row['package_id'] ?>">Delete &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fas fa-trash text-danger"></span></a>
										</div>
						...
						if(isset($_SESSION['user'])){
							...
							$package = "SELECT * FROM packages WHERE sender_name = '$_SESSION[fullname]'  ORDER BY package_id DESC"or die(mysqli_error($conn));
								...
								<li class="nav-item">
										<div class="btn-group nav-link me-3">
											...
											<div class="dropdown-menu me-4" role="menu" style="width: 30px;">
												...
												<a onclick='javacript: confirmDeletion(event); return false;' class="dropdown-item ms-" href="delete_parcel.php?delete_id=<?php echo $row['package_id'] ?>">Delete &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fas fa-trash text-danger"></span></a>
											</div>
...
<!---------------------------- confirm function before delete item  ----------------------->
<script>
	function confirmDeletion(e){
		var confirmBeforeDelete = confirm("Are you sure you want to delete this item?");
